...
declare_id!("5QSLAn7PcSKmL3tBnhz6GssdmHaEif5y8eoCHR1u2fD6");
...
pub struct Initialize<'info> {
    ...
    // Create and initialize `Counter` account using a PDA as the address (function and type all together)
    #[account(
        init,
